    ...
    return (
        ...
        <Main>
            ...
            <section>
                <h2>進捗</h2>
                <ul>
                    <li>タグの和暦、西暦、地域を優先度順で表示 <a href="https://github.com/ryo-i/dai-sengoku-nenpyo/issues/3" target="_blank">#3</a></li>
                    <li>地域などの項目名を整理 <a href="https://github.com/ryo-i/dai-sengoku-nenpyo/issues/2" target="_blank">#2</a></li>
                </ul>
            </section>
            <section>
                <h2>今後の予定</h2>
