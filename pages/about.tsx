    ...
    return (
        ...
        <Main>
            ...
            <section>
                <h2>進捗</h2>
                <ul>
                    <li>家康死去までの出来事追加 <a href="https://github.com/ryo-i/dai-sengoku-nenpyo/issues/2" target="_blank">#2</a></li>
                    <li>IndexとCategoryの概要を共通化 <a href="https://github.com/ryo-i/dai-sengoku-nenpyo/issues/3" target="_blank">#3</a></li>
                </ul>
            </section>
            <section>
                <h2>今後の予定</h2>
